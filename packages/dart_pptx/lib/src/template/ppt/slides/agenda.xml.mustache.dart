...
/// Path: ./template\ppt\slides\agenda.xml.mustache
...
<p:sld xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"
    ...
    <p:cSld>
        ...
        <p:spTree>
            ...
            <p:sp>
                <p:nvSpPr>
                    <p:cNvPr id="{{new-id}}" name="AGENDA TITLE"/>
                    <p:cNvSpPr txBox="1"/>
                    <p:nvPr>
                        <p:ph type="title"/>
                    </p:nvPr>
            ...
            <p:sp>
                <p:nvSpPr>
                    <p:cNvPr id="{{new-id}}" name="AGENDA TOPICS"/>
                    <p:cNvSpPr txBox="1"/>
                    <p:nvPr>
            ...
            <p:sp>
                <p:nvSpPr>
                    <p:cNvPr id="{{new-id}}" name="Agenda Subtitle"/>
                    <p:cNvSpPr txBox="1"/>
                    <p:nvPr>
